# LuxeThread Florida 🌴
**Premium Coastal Streetwear E-Commerce Experience**
...
* **Premium Aesthetic:** Uses a sophisticated palette of Navy (`#0F1C2E`), Gold (`#D4AF87`), and Cream (`#F8F4ED`) with elegant **Playfair Display** typography.
...
```text
├── index.html          # Luxury Hero & Featured Collections
├── tshirts.html        # Product listing (5 items)
├── hats.html           # Product listing (5 items)
├── shorts.html         # Product listing (5 items)
├── shoes.html          # Product listing (5 items)
├── combos.html         # Interactive Outfit Builder (LuxeBuilder™)
├── about.html          # Brand Story & Philosophy
├── contact.html        # SEO-Optimized Contact & Audit Request Form
└── images/             # Directory for all product and lifestyle assets
